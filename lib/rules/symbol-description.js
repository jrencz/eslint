...
module.exports = {
    meta: {
        docs: {
            description: "disallow or enforce description with the `Symbol`" +
            " object",
    ...
    create: function(context) {
         ...
         * report present description
         *
         * @param {ASTNode} node - A CallExpression node to check.
         * @returns {void}
         */
        function reportIfDescriptionIsPresent(node) {
        ...
        function checkArgument(node) {
            switch (mode) {
                case MODE_ALWAYS:
                    ...
                    break;
                case MODE_NEVER:
                    reportIfDescriptionIsPresent(node);
                    break;
                default:
                    reportIfDescriptionIsMissing(node);
            }
